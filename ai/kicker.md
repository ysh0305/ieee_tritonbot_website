...
The kicker subsystem enables controlled ball propulsion for passing and shooting. The following sections describe the MkII and MkIII implementations.

<Tabs groupId="kicker-version">
