  ...
  return (
    <Layout
      ...
      <main className='w-screen bg-black'>
        <img src="/img/side.svg" className='absolute left-0 z-20 w-[4vw]'/>
        <img src="/img/side.svg" className='absolute left-[95vw] z-20 w-[4vw]'/>
        <div className='w-screen flex items-center flex-col'>
          <div className='w-screen h-[64vw] relative flex justify-center'>
            <img src="/img/title.svg" alt="Landing Title" className='absolute z-10 top-[-5%] w-[90%]'/>
            <img src="/img/landing.png" alt="Landing Background Image" className='absolute top-[-10%]'/>
          </div>
          ...
          <div className='relative flex w-[75%] bg-white rounded-[3vw] py-[1.2vw] px-[4vw] text-black h-[25vw]'>
            ...
            <img src="/img/about.svg" className='w-[38vw] absolute right-[-3%] top-[-5%]'/>
          </div>
      ...
      <footer className="bg-[#454545] w-screen h-[15vw] flex justify-between px-[10vw] items-center">
        <img src="/img/Resources.svg" className="w-[12vw]"/>
        <div>
